      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.list}>
          ...
          <p>
            ...
            nutdanai.kpjr@gmail.com so we can try to find a solution. These
          ...
          <p>
            You may provide us&nbsp;either directly at nutdanai.kpjr@gmail.com
            ...
            (&ldquo;
            <strong>Feedback</strong>&rdquo;). You acknowledge and agree that:
